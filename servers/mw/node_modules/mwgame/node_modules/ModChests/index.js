...
O2.extendClass('ModChests', Plugin, {
	...
	openChest: function(oInstance, x, y, nUntil) {
		...
		if (!cry[x]) {
			cry[x] = nUntil;
			var m = oInstance.getMapBlock(x, y);
			m = ((m & 0xFF) + 1) | (m & 0xFFFFFF00);
			oInstance.setMapBlock(x, y, m, 'CHEST_OPEN');
		} // sinon : déja ouvert
	},
	...
	closeChest: function(oInstance, x, y) {
		...
		var m = oInstance.getMapBlock(x, y);
		m = ((m & 0xFF) - 1) | (m & 0xFFFFFF00);
		oInstance.setMapBlock(x, y, m, 'CHEST_CLOSE');
	}
});
