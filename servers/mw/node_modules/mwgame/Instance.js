...
var Instance = O2.createClass({
	...
	getMapBlockPhys: function(x, y) {
		return (this._oLevel.map[y][x] & 0xFF00) >> 8; // code12: (this._oLevel.map[y][x] >> 12) & 0xF
	},
	...
	setMapBlockPhys: function(x, y, b) {
		this._oLevel.map[y][x] = (this._oLevel.map[y][x] & 0xFFFF00FF) | (b << 8);   // code12: (this._oLevel.map[y][x] & 0xFFFF0FFF) | (b << 12)
	},
