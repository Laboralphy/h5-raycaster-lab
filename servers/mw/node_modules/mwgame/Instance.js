...
var Instance = O2.createClass({
	...
	getMapBlockPhys: function(x, y) {
		return (this._oLevel.map[y][x] & 0xFFFFFF00) >> 8; // code12: (this._oLevel.map[y][x] >> 12) & 0xF
	},
	
	getMapBlockCode: function(x, y) {
		return this._oLevel.map[y][x] & 0xFF; // code12: (this._oLevel.map[y][x] & 0xFFF
	},
	...
	setMapBlockPhys: function(x, y, b, sTag) {
		this.setMapBlock(x, y, (this._oLevel.map[y][x] & 0xFFFF00FF) | (b << 8), sTag); // code12: (this._oLevel.map[y][x] & 0xFFFF0FFF) | (b << 12)
	},
	
	setMapBlockCode: function(x, y, b, sTag) {
		this.setMapBlock(x, y, (this._oLevel.map[y][x] & 0xFFFFFF00) | b, sTag); // code12: (this._oLevel.map[y][x] & 0xFFFFF000) | b
	},
