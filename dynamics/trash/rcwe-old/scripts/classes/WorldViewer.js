O2.extendClass('RCWE.WorldViewer', RCWE.Window, {
	...
	build: function() {
		...
		var $oScript = $('<textarea style="width: 95%; height: 95%; font-size: 75%"></textarea>');
		$oScript.hide();
		...
		this.getBody().css('text-align', 'center').append($oCanvas).append($oScript);//.append('<div style="font-family: monospace">Use the arrow keys <b>←↑↓→</b> to move the camera. Use <b>C</b> to straffe. Press <b>SPACE</b> to open doors.</div>');
