...
require_once 'ChronoTrigger.php';
require_once 'Grid.php';
require_once 'RandomGenerator.php';
require_once 'LabyRoomHelper.php';
require_once 'RoomGenerator.php';
require_once 'LabyRoom.php';
require_once 'Blox.php';
require_once 'SecretGenerator.php';
require_once 'LabyGenerator.php';
require_once 'LevelGenerator.php';
require_once 'LevelToolKit.php';
...
<html>
  <head>
    ...
    <script src="../../libraries/o2.js" type="text/javascript"></script>
    <script src="../../libraries/XHR.js" type="text/javascript"></script>
  	<script src="../../libraries/Raycaster/Tools/MathTools.js" type="text/javascript"></script>
    <script src="../../libraries/Raycaster/Tools/Astar.js" type="text/javascript"></script>
