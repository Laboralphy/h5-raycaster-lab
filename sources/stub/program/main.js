...
/**
 * Enters pointerlock mode. The mouse cursor is forzne while inside 
 * this mode. The function will return true if the operation is successful.
 * @param oElement
 * @returns {Boolean}
 */
...
/**
 * Re-compute metrics on resize events 
 */
